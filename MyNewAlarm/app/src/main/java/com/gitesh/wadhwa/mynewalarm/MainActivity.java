package com.gitesh.wadhwa.mynewalarm;
...
public class MainActivity extends AppCompatActivity {
    ...
    i1.setAction("com.wadhwa.gitesh.myown.receiver.Message");
    ...
    public void stopSomething(View view) {
       ...
       myAlarmManager.cancel(pd);
        Toast.makeText(this,"Alarm clock has Stopped",Toast.LENGTH_SHORT).show();
    }
}
